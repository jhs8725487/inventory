            ...
            <div class="card-body">
                <form action="{{ route('clients.update', $client->id) }}" method="POST" >
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="street" id="street" class="form-control" value="{{ $client->address_street }}">
                    </div>
              
                    <div class="form-group">
                        <label for="phone">Phone</label>
                        <input type="text" name="phone" id="phone" class="form-control" value="{{ $client->phone_number }}">
                    </div>
